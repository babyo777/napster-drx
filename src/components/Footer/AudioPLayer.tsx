                  ...
                  {playlist[currentIndex].artists[0]?.name ? (
                    ...
                    >
                      <DrawerClose className="text-start">
                        <p className="text-base truncate transition-all duration-300 fade-in  w-[70vw] text-red-500">
                          {" "}
                          {playlist[currentIndex].artists[0]?.name}
                        </p>
                      </DrawerClose>
                    ...
                    <p className="text-base truncate transition-all duration-300 fade-in  w-64 text-red-500">
                      {" "}
                      Unknown
                    </p>
                  )}
