    ...
    >
      <CarouselContent className="rounded-xl">
        <CarouselItem className="rounded-xl">
          <CarouselSlide image="https://cdn.discordapp.com/attachments/1213096773342601246/1213096773829001256/RPReplay_Final1709229551.mov?ex=65f43b69&is=65e1c669&hm=8b85aa134b7fb96f2fbae629294c2876ca6cc7e6da108edb5aacde51eb869437&" text="Slide 1" />
        </CarouselItem>
        <CarouselItem className="rounded-xl">
        ...
        <CarouselItem className="rounded-xl">
          <CarouselSlide image="/ui/Andriod/cropped-tele 2.jpg" text="Slide 3" />
        </CarouselItem>
        <CarouselItem className="rounded-xl">
